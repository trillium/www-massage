...
export async function fetchDataByQuery({
  ...
  const members = events.filter((e: GoogleCalendarV3Event) => {
    ...
    console.log(e.summary.includes(member_string))
    console.log(e.description)
    console.log(e.description?.includes(member_string))
    return (
  ...
  console.log(busyQuery)

  const container = events.filter((e: GoogleCalendarV3Event) => {
    console.log(e)
    console.log(e.summary)
    console.log(container_string)
    console.log(e.summary.includes(container_string))
    console.log(e.description)
    console.log(e.description?.includes(container_string))
    return (
  ...
  const free = container.map((e: GoogleCalendarV3Event) => {
    return { start: e.start.dateTime, end: e.end.dateTime }
  })
